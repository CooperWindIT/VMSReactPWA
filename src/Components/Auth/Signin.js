...
export default function Signin() {
    ...
    return (
        <div>
            ...
            <div className={`container ${isRightPanelActive ? "right-panel-active" : ""}`} id="container">
                <div className="form-container sign-up-container">
                    <form action="#">
                        ...
                        <input type="text" placeholder="Name" autoComplete="new-user-name" />
                ...
                <div className="form-container sign-in-container">
                    <form action="#">
                        ...
                        <input type="email" placeholder="Email" autoComplete="new-user-name" />
                        <input type="password" placeholder="Password" autoComplete="new-password" />
            ...
            <footer>
                <p>
                    Created with <i className="bi bi-heart"></i> by
                    <a target="_blank" rel="noreferrer" href="#">CWI</a>
                    - Read how I created this and how you can join the challenge
                    <a target="_blank" rel="noreferrer" href="#">here</a>.
                </p>
            </footer>
            <style>
                {
                    `
                        ...
                        * {
                        ...
                        .overlay {
                            background: #FF416C;
                            background: -webkit-linear-gradient(to right, #284e62, #FF416C);
                            background: linear-gradient(to right, #284e62, #FF416C);
